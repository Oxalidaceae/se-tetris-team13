...
public class KeySettingsScene {
    ...
    public Scene getScene() {
        ...
        rightBtn2 = new Button("Move Right: " + KeyCode.valueOf(settings.getKeyRightP2()).getName());
        ...
        // Player 1 버튼 이벤트 핸들러
        leftBtn.setOnAction(e -> { waitingForKey = "LEFT"; highlightSelectedButton(leftBtn); });
        rightBtn.setOnAction(e -> { waitingForKey = "RIGHT"; highlightSelectedButton(rightBtn); });
        downBtn.setOnAction(e -> { waitingForKey = "DOWN"; highlightSelectedButton(downBtn); });
        rotateBtn.setOnAction(e -> { waitingForKey = "ROTATE"; highlightSelectedButton(rotateBtn); });
        dropBtn.setOnAction(e -> { waitingForKey = "DROP"; highlightSelectedButton(dropBtn); });
        pauseBtn.setOnAction(e -> { waitingForKey = "PAUSE"; highlightSelectedButton(pauseBtn); });
        
        // Player 2 버튼 이벤트 핸들러
        leftBtn2.setOnAction(e -> { waitingForKey = "LEFT_P2"; highlightSelectedButton(leftBtn2); });
        rightBtn2.setOnAction(e -> { waitingForKey = "RIGHT_P2"; highlightSelectedButton(rightBtn2); });
        downBtn2.setOnAction(e -> { waitingForKey = "DOWN_P2"; highlightSelectedButton(downBtn2); });
        rotateBtn2.setOnAction(e -> { waitingForKey = "ROTATE_P2"; highlightSelectedButton(rotateBtn2); });
        dropBtn2.setOnAction(e -> { waitingForKey = "DROP_P2"; highlightSelectedButton(dropBtn2); });
        
        backBtn.setOnAction(e -> manager.showSettings(settings));

        // Player 1 컬럼
        VBox player1Column = new VBox(
            10,
            player1Title,
            leftBtn,
            rightBtn,
    ...
    private void highlightSelectedButton(Button selectedButton) {
        ...
        selectedButton.setStyle("-fx-background-color: #FFD700; -fx-text-fill: #000000; -fx-font-weight: bold;");
    }
