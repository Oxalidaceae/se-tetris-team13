        ...
        javafx.application.Platform.runLater(
                () -> {
                    ...
                    assertEquals(
                            ...
                            "Layout should have 5 children (title + 4 buttons)");
                    assertEquals(
                            "-fx-alignment: center;",
                            layout.getStyle(),
        ...
        javafx.application.Platform.runLater(
                () -> {
                    ...
                    assertEquals(
                            "Select Difficulty",
                            title.getText(),
                            "Title text should be 'Select Difficulty'");
                    assertTrue(
    ...
    void testNormalButton() {
        javafx.application.Platform.runLater(
                () -> {
                    ...
                    assertEquals(
                            "Normal", normalBtn.getText(), "Normal button text should be 'Normal'");
                    assertNotNull(
                            normalBtn.getOnAction(), "Normal button should have action handler");
                });
    ...
    void testSceneManagerIntegration() {
        javafx.application.Platform.runLater(
                () -> {
                    ...
                    assertNotNull(
                            difficultyScene, "DifficultySelectionScene should be initialized");
                });
