    ...
    void testSmallButton() {
        javafx.application.Platform.runLater(
                () -> {
                    ...
                    assertNotNull(
                            smallBtn.getOnAction(), "Small button should have action handler");
                });
    ...
    void testMediumButton() {
        javafx.application.Platform.runLater(
                () -> {
                    ...
                    assertNotNull(
                            mediumBtn.getOnAction(), "Medium button should have action handler");
                });
    ...
    void testLargeButton() {
        javafx.application.Platform.runLater(
                () -> {
                    ...
                    assertNotNull(
                            largeBtn.getOnAction(), "Large button should have action handler");
                });
        ...
        javafx.application.Platform.runLater(
                () -> {
                    ...
                    assertEquals(
                            "Key Settings",
                            keyBtn.getText(),
                            "Button text should be 'Key Settings'");
                    assertNotNull(
                            keyBtn.getOnAction(), "Key Settings button should have action handler");
                });
    ...
    void testColorBlindToggle() {
        javafx.application.Platform.runLater(
                () -> {
                    ...
                    assertTrue(
                            layout.getChildren().get(5) instanceof ToggleButton,
                    ...
                    assertTrue(
                            colorBlindBtn.getText().contains("Color Blind Mode"),
                            "Toggle button text should contain 'Color Blind Mode'");
                    assertNotNull(
                            colorBlindBtn.getOnAction(),
    ...
    void testButtonOrder() {
        javafx.application.Platform.runLater(
                () -> {
                    ...
                    Label title = (Label) layout.getChildren().get(0);
                    assertEquals(
                            expectedTexts[0], title.getText(), "Title should be at position 0");
    ...
    void testAllButtonsHaveHandlers() {
        javafx.application.Platform.runLater(
                () -> {
                    ...
                    assertNotNull(
                            toggleBtn.getOnAction(), "ToggleButton should have action handler");
                });
