...
public class GameOverSceneTest {
  ...
  void testScoreDisplay() {
    javafx.application.Platform.runLater(() -> {
      ...
      assertEquals("Your Score: " + TEST_SCORE, scoreLabel.getText(),
  ...
  void testNameInputField() {
    javafx.application.Platform.runLater(() -> {
      ...
      assertEquals("Enter your name", nameField.getPromptText(),
  ...
  void testStatusLabel() {
    javafx.application.Platform.runLater(() -> {
      ...
      assertTrue(statusLabel.getText().isEmpty() || statusLabel.getText() != null,
  ...
  void testDifferentScores() {
    javafx.application.Platform.runLater(() -> {
      ...
      for (int score : testScores) {
        ...
        assertEquals("Your Score: " + score, scoreLabel.getText(),
