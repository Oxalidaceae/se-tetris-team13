...
public class MainMenuSceneTest {
    ...
    void testSceneLayout() {
        javafx.application.Platform.runLater(() -> {
            ...
            assertEquals(6, layout.getChildren().size(), "Layout should have 6 children (title + 5 buttons)");
    ...
    void testStartGameButton() {
        javafx.application.Platform.runLater(() -> {
            ...
            assertEquals("Start Game", startBtn.getText(), "Start button text should be 'Start Game'");
    ...
    void testStartItemModeButton() {
        javafx.application.Platform.runLater(() -> {
            ...
            assertEquals("Start Item Mode", itemModeBtn.getText(),
    ...
    void testOptionsButton() {
        javafx.application.Platform.runLater(() -> {
            ...
            assertEquals("Options", optionBtn.getText(), "Options button text should be 'Options'");
    ...
    void testScoreboardButton() {
        javafx.application.Platform.runLater(() -> {
            ...
            assertEquals("Scoreboard", scoreBtn.getText(), "Scoreboard button text should be 'Scoreboard'");
    ...
    void testButtonOrder() {
        javafx.application.Platform.runLater(() -> {
            ...
            assertEquals("Start Game", ((Button) layout.getChildren().get(1)).getText(),
                    "First button should be Start Game");
            assertEquals("Start Item Mode", ((Button) layout.getChildren().get(2)).getText(),
                    "Second button should be Start Item Mode");
            assertEquals("Options", ((Button) layout.getChildren().get(3)).getText(),
                    "Third button should be Options");
            assertEquals("Scoreboard", ((Button) layout.getChildren().get(4)).getText(),
    ...
    void testChildTypes() {
        javafx.application.Platform.runLater(() -> {
            ...
            for (int i = 1; i <= 5; i++)
                assertTrue(layout.getChildren().get(i) instanceof Button, "Child " + i + " should be Button");
        });
    ...
    void testSettingsInjection() {
        javafx.application.Platform.runLater(() -> {
            ...
            assertNotNull(settings.getKeyLeft(), "Settings should have key left configured");
            assertNotNull(settings.getKeyRight(), "Settings should have key right configured");
        });
