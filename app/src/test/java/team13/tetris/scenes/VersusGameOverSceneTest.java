...
public class VersusGameOverSceneTest {
    ...
    void testLocalModeScene() throws Exception {
        ...
        Platform.runLater(
                () -> {
                    VersusGameOverScene scene =
                            new VersusGameOverScene(
    ...
    void testTimerModeScene() throws Exception {
        ...
        Platform.runLater(
                () -> {
                    VersusGameOverScene scene =
                            new VersusGameOverScene(
                                    mockManager, mockSettings, "Player 2", 1500, 1200, true, false);
    ...
    void testItemModeScene() throws Exception {
        ...
        Platform.runLater(
                () -> {
                    VersusGameOverScene scene =
                            new VersusGameOverScene(
                                    mockManager, mockSettings, "Player 1", 2000, 1800, false, true);
    ...
    void testDefaultConstructor() throws Exception {
        ...
        Platform.runLater(
                () -> {
                    VersusGameOverScene scene =
                            new VersusGameOverScene(
                                    mockManager, mockSettings, "Player 2", 1100, 900, false, false);
