...
public class GameSceneTest {
    ...
    void testRootStyleClass() {
        javafx.application.Platform.runLater(() -> {
            ...
            assertTrue(root.getStyleClass().contains("game-root"), "Root should have 'game-root' style class");
        });
    ...
    void testBoardGridExists() {
        javafx.application.Platform.runLater(() -> {
            ...
            assertTrue(root.getChildren().get(0) instanceof GridPane, "First child should be GridPane (board)");
        });
    ...
    void testBoardGridSize() {
        javafx.application.Platform.runLater(() -> {
            ...
            assertEquals(expectedCells, boardGrid.getChildren().size(), "Board grid should have " + expectedCells + " cells including borders");
        });
    ...
    void testBoardGridStyleClass() {
        javafx.application.Platform.runLater(() -> {
            ...
            assertTrue(boardGrid.getStyleClass().contains("board-grid"), "Board grid should have 'board-grid' style class");
        });
    ...
    void testUpdateGridExecution() {
        javafx.application.Platform.runLater(() -> {
            ...
            assertDoesNotThrow(() -> gameScene.updateGrid(), "updateGrid should execute without throwing exceptions");
        });
    ...
    void testUpdateGridWithNullEngine() {
        javafx.application.Platform.runLater(() -> {
            ...
            assertDoesNotThrow(() -> gameScene.updateGrid(), "updateGrid should handle null engine gracefully");
        });
    ...
    void testRequestFocus() {
        javafx.application.Platform.runLater(() -> {
            ...
            assertDoesNotThrow(() -> gameScene.requestFocus(), "requestFocus should execute without throwing exceptions");
        });
    ...
    void testSetEngine() {
        javafx.application.Platform.runLater(() -> {
            ...
            assertDoesNotThrow(() -> gameScene.setEngine(newEngine), "setEngine should work without errors");
        });
