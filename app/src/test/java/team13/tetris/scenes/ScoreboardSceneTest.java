...
public class ScoreboardSceneTest {
    ...
    void testScoreListExists() {
        javafx.application.Platform.runLater(() -> {
            ...
            assertTrue(layout.getChildren().get(1) instanceof ListView, "Second child should be ListView");
    ...
    void testConstructorWithHighlight() {
        javafx.application.Platform.runLater(() -> {
            ...
            ScoreboardScene scene = new ScoreboardScene(sceneManager, settings, testName, testScore, testMode);
