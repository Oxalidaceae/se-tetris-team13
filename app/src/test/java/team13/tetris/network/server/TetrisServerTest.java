...
class TetrisServerTest {
    ...
    void testGameModeSelectionWithClients() {
        assertDoesNotThrow(() -> {
            // 게임 모드 먼저 선택
            server.selectGameMode(GameModeMessage.GameMode.ITEM);
            assertEquals(GameModeMessage.GameMode.ITEM, server.getSelectedGameMode(), "선택된 게임 모드 확인");
    ...
    void testClientReadyState() {
        assertDoesNotThrow(() -> {
            // 존재하지 않는 클라이언트
            assertFalse(server.isClientReady("NonExistentClient"), "존재하지 않는 클라이언트는 준비되지 않음");
    ...
    void testRejectConnectionViaReflection() throws Exception {
        java.lang.reflect.Method rejectMethod = TetrisServer.class.getDeclaredMethod(
    ...
    void testGetActivePlayerIdsViaReflection() throws Exception {
        java.lang.reflect.Method getActiveIdsMethod = TetrisServer.class.getDeclaredMethod(
            "getActivePlayerIds"
        );
    ...
    void testStartGameViaReflection() throws Exception {
        java.lang.reflect.Method startGameMethod = TetrisServer.class.getDeclaredMethod(
            "startGame", long.class
        );
    ...
    void testEndGameViaReflection() throws Exception {
        java.lang.reflect.Method endGameMethod = TetrisServer.class.getDeclaredMethod(
    ...
    void testAcceptClientsViaReflection() throws Exception {
        java.lang.reflect.Method acceptClientsMethod = TetrisServer.class.getDeclaredMethod(
            "acceptClients"
        );
    ...
    void testHostPlayerIdField() throws Exception {
        java.lang.reflect.Field hostPlayerIdField = TetrisServer.class.getDeclaredField("hostPlayerId");
    ...
    void testGameInProgressField() throws Exception {
        java.lang.reflect.Field gameInProgressField = TetrisServer.class.getDeclaredField("gameInProgress");
    ...
    void testSelectedGameModeField() throws Exception {
        java.lang.reflect.Field selectedGameModeField = TetrisServer.class.getDeclaredField("selectedGameMode");
        selectedGameModeField.setAccessible(true);
        
        GameModeMessage.GameMode selectedGameMode = (GameModeMessage.GameMode) selectedGameModeField.get(server);
    ...
    void testConnectedClientsField() throws Exception {
        java.lang.reflect.Field connectedClientsField = TetrisServer.class.getDeclaredField("connectedClients");
    ...
    void testPlayerReadyStatesField() throws Exception {
        java.lang.reflect.Field playerReadyStatesField = TetrisServer.class.getDeclaredField("playerReadyStates");
    ...
    void testCountdownTimerField() throws Exception {
        java.lang.reflect.Field countdownTimerField = TetrisServer.class.getDeclaredField("countdownTimer");
    ...
    void testCurrentCountdownIdField() throws Exception {
        java.lang.reflect.Field currentCountdownIdField = TetrisServer.class.getDeclaredField("currentCountdownId");
