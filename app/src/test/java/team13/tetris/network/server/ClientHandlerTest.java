...
class ClientHandlerTest {
    ...
    void testCleanupInVariousStates() throws IOException {
        assertDoesNotThrow(() -> {
            ...
            when(normalSocket.getInputStream()).thenReturn(new java.io.ByteArrayInputStream(new byte[0]));
    ...
    void testSetupStreamsViaReflection() throws Exception {
        ...
        java.lang.reflect.Method setupStreamsMethod = ClientHandler.class.getDeclaredMethod("setupStreams");
    ...
    void testSendMessageWithNullOutput() throws Exception {
        ...
        team13.tetris.network.protocol.ConnectionMessage message = 
            team13.tetris.network.protocol.ConnectionMessage.createConnectionAccepted("server", "player1");
    ...
    void testMessageLoopViaReflection() throws Exception {
        ...
        java.lang.reflect.Method messageLoopMethod = ClientHandler.class.getDeclaredMethod("messageLoop");
