...
class ConnectionMessageTest {
    ...
    void testHasTargetWithEmptyString() {
        ConnectionMessage message = new ConnectionMessage(MessageType.CONNECTION_ACCEPTED, "Server", "Welcome", "   ");
    ...
    void testIsConnectionRequest() {
        ConnectionMessage requestMsg = ConnectionMessage.createConnectionRequest("Player1", "PlayerName");
    ...
    void testIsConnectionResponse() {
        ConnectionMessage acceptedMsg = ConnectionMessage.createConnectionAccepted("Server", "Player1");
        ConnectionMessage rejectedMsg = ConnectionMessage.createConnectionRejected("Server", "Server is full");
        ConnectionMessage disconnectMsg = new ConnectionMessage(MessageType.DISCONNECT, "Player1", "Bye");
