...
class GameEngineAdvancedTest {
    ...
    void testDifficultyPerformanceDifferences() {
        ...
        GameEngine easyEngine =
                new GameEngine(new Board(10, 20), easyListener, ScoreBoard.ScoreEntry.Mode.EASY);
        GameEngine hardEngine =
                new GameEngine(new Board(10, 20), hardListener, ScoreBoard.ScoreEntry.Mode.HARD);
