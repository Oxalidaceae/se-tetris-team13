...
public class GameEngineTest {
    ...
    void testDestroyBlocksBelow_SingleLine() throws Exception {
        ...
        // 무게추 블록 설정
        Tetromino weightBlock = Tetromino.item(Tetromino.Kind.WEIGHT, 0, Tetromino.ItemType.WEIGHT, 0);
        Field currentField = GameEngine.class.getDeclaredField("current");
        currentField.setAccessible(true);
        ...
        // When
        Method destroyBlocksBelow = GameEngine.class.getDeclaredMethod("destroyBlocksBelow", boolean.class);
    ...
    void testProcessItemEffect_CopyItem() throws Exception {
        ...
        // When
        Method processItemEffect = GameEngine.class.getDeclaredMethod("processItemEffect", 
            Tetromino.ItemType.class, Tetromino.Kind.class);
        processItemEffect.setAccessible(true);
        processItemEffect.invoke(gameEngine, Tetromino.ItemType.COPY, Tetromino.Kind.I);
        
        // Then
        verify(mockListener, atLeastOnce()).onPieceSpawned(any(Tetromino.class), anyInt(), anyInt());
    ...
    void testCreateItemPiece_CopyItem() throws Exception {
        // When
        Method createItemPiece = GameEngine.class.getDeclaredMethod("createItemPiece", 
            Tetromino.Kind.class, Tetromino.Kind.class);
        createItemPiece.setAccessible(true);
        Tetromino copyItem = (Tetromino) createItemPiece.invoke(gameEngine, 
            Tetromino.Kind.COPY, Tetromino.Kind.I);
    ...
    void testCreateItemPiece_WeightItem() throws Exception {
        ...
        Method createItemPiece = GameEngine.class.getDeclaredMethod("createItemPiece", 
            Tetromino.Kind.class, Tetromino.Kind.class);
        createItemPiece.setAccessible(true);
        Tetromino weightItem = (Tetromino) createItemPiece.invoke(gameEngine, 
            Tetromino.Kind.WEIGHT, null);
    ...
    void testGetLastLockedColumns() throws Exception {
        ...
        // When
        Method recordLastLockedColumns = GameEngine.class.getDeclaredMethod("recordLastLockedColumns");
    ...
    void testCreateLineClearItemPiece() throws Exception {
        // When
        Method createLineClearItemPiece = GameEngine.class.getDeclaredMethod("createLineClearItemPiece", 
            Tetromino.Kind.class);
        createLineClearItemPiece.setAccessible(true);
        Tetromino lineClearItem = (Tetromino) createLineClearItemPiece.invoke(gameEngine, Tetromino.Kind.T);
    ...
    void testDestroyLineDirectlyBelow() throws Exception {
        ...
        // When
        Method destroyLineDirectlyBelow = GameEngine.class.getDeclaredMethod("destroyLineDirectlyBelow");
    ...
    void testCreateItemPiece_GravityItem() throws Exception {
        ...
        Method createItemPiece = GameEngine.class.getDeclaredMethod("createItemPiece", 
            Tetromino.Kind.class, Tetromino.Kind.class);
        createItemPiece.setAccessible(true);
        Tetromino gravityItem = (Tetromino) createItemPiece.invoke(gameEngine, 
            Tetromino.Kind.GRAVITY, null);
    ...
    void testCreateItemPiece_SplitItem() throws Exception {
        ...
        Method createItemPiece = GameEngine.class.getDeclaredMethod("createItemPiece", 
            Tetromino.Kind.class, Tetromino.Kind.class);
        createItemPiece.setAccessible(true);
        Tetromino splitItem = (Tetromino) createItemPiece.invoke(gameEngine, 
            Tetromino.Kind.SPLIT, null);
    ...
    void testHandleLockedPiece_ItemBlock() throws Exception {
        ...
        // GRAVITY 아이템 블록 설정
        Tetromino gravityBlock = Tetromino.item(Tetromino.Kind.GRAVITY, 0, Tetromino.ItemType.GRAVITY, 0);
        Field currentField = GameEngine.class.getDeclaredField("current");
        currentField.setAccessible(true);
    ...
    void testCreateItemPiece_FallbackCopy() throws Exception {
        ...
        Tetromino fallbackItem = (Tetromino) createItemPiece.invoke(gameEngine, 
            Tetromino.Kind.I, Tetromino.Kind.T); // I를 아이템 타입으로 사용 (비정상적 케이스)
