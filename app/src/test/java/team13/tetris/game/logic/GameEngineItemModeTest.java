...
// GameEngine 아이템 모드 테스트: Tests item mode functionality, item piece generation, and item effects
...
public class GameEngineItemModeTest {
    ...
    void testLineClearItemCreation() {
        ...
        assertEquals(1, lineClearItem.getLineClearBlockIndex(), "라인 클리어 블록 인덱스가 1이어야 함");
    }
    ...
    void testItemModeScoring() {
        ...
        // 1줄 채우기
        for (int col = 0; col < 10; col++) board.setCell(col, 19, 1);
