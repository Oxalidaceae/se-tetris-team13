...
public class GameEngineDifficultyTest {
    ...
    private static class NoOpListener implements GameStateListener {
        ...
        @Override public void onPieceSpawned(Tetromino piece, int x, int y) {}
        @Override public void onBoardUpdated(Board board) {}
        @Override public void onLinesCleared(int linesCleared) {}
        @Override public void onNextPiece(Tetromino nextPiece) {}
    }
    ...
    private void testBlockDistribution(ScoreBoard.ScoreEntry.Mode difficulty, int samples) {
        ...
        for (int i = 0; i < samples; i++) {
            ...
            if (kind != null) {
                switch (kind) {
                    ...
                    case Z: counts[4]++; break;
                    case J: counts[5]++; break;
                    case L: counts[6]++; break;
                }
            }
        }
        ...
        // Verify I-block is within reasonable range (5% margin for statistical variance)
