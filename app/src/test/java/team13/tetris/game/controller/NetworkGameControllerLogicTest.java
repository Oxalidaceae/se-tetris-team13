...
class NetworkGameControllerLogicTest {
    ...
    void testBoardUpdateMessageHandling() {
        ...
        BoardUpdateMessage message2 =
                new BoardUpdateMessage(
                        ...
                        12,
                        2);
        BoardUpdateMessage largeMessage =
                new BoardUpdateMessage(
                        "Player3",
                        largeBoard,
                        25,
                            ...
                            () -> {
                                try {
                                    ...
                                    hostController.onGameModeSelected(
                                            index % 2 == 0
                                                    ? GameModeMessage.GameMode.NORMAL
                    ...
                    for (int i = 0; i < 10; i++) {
                        ...
                        if (i % 3 == 0) {
                            AttackMessage attackMsg =
                                    new AttackMessage("Attacker" + i, i % 4 + 1, i % 4 + 1, null);
    ...
    void testMemoryEfficiency() {
        assertDoesNotThrow(
                () -> {
                    ...
                    for (int i = 0; i < 100; i++) {
                        AttackMessage attackMsg =
                                new AttackMessage("Attacker" + (i % 5), i % 4 + 1, i % 4 + 1, null);
                        hostController.onAttackReceived(attackMsg);
                    }
                },
    ...
    void testVariousServerSettings() {
        ...
        for (String ip : testIPs) {
            assertDoesNotThrow(
                    () -> {
                        NetworkGameController testHost =
                                new NetworkGameController(null, settings, true, ip);
                        NetworkGameController testClient =
                                new NetworkGameController(null, settings, false, ip);
