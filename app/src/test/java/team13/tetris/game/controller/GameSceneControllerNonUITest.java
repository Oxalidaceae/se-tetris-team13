...
class GameSceneControllerNonUITest {
    ...
    static class TestSceneManager extends SceneManager {
        ...
        public void showConfirmScene(
                Settings settings, String message, Runnable onConfirm, Runnable onCancel) {}
    ...
    static class TestKeyInputHandler extends KeyInputHandler {
        ...
        public void attachToScene(
                javafx.scene.Scene scene, KeyInputHandler.KeyInputCallback callback) {}
    }
