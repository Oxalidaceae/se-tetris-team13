...
class VersusGameControllerSimpleTest {
    ...
    void testVersusGameControllerInnerClasses() {
        // given
        Settings settings = new Settings();
        VersusGameController controller =
                new VersusGameController(null, null, settings, null, null, false, false);
        ...
        assertDoesNotThrow(
                () -> {
                    java.lang.reflect.Field[] fields =
                            VersusGameController.class.getDeclaredFields();
        ...
        assertDoesNotThrow(
                () -> {
                    java.lang.reflect.Method[] methods =
                            VersusGameController.class.getDeclaredMethods();
                    ...
                    assertTrue(
                            hasPrivateMethods || hasPublicMethods,
                            "VersusGameController에 메서드들이 정의되어 있어야 함");
                },
    ...
    void testVersusGameControllerClassInfo() {
        // when & then - 클래스 정보 확인
        assertEquals(
                "VersusGameController",
                VersusGameController.class.getSimpleName(),
                "클래스 이름이 VersusGameController여야 함");

        assertEquals(
                "team13.tetris.game.controller",
                VersusGameController.class.getPackageName(),
                "패키지 이름이 올바르게 설정되어야 함");

        assertFalse(
                VersusGameController.class.isInterface(), "VersusGameController는 인터페이스가 아니어야 함");
        assertFalse(
                java.lang.reflect.Modifier.isAbstract(VersusGameController.class.getModifiers()),
