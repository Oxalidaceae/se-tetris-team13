...
class VersusGameControllerNonUITest {
    ...
    void testVersusGameControllerReflectionMethods() throws Exception {
        ...
        java.lang.reflect.Method shouldProcessKeyMethod =
                VersusGameController.class.getDeclaredMethod(
                        "shouldProcessKey", java.util.Map.class, Object.class, long.class);
        ...
        Boolean result =
                (Boolean) shouldProcessKeyMethod.invoke(controller, keyMap, "LEFT", currentTime);
        assertFalse(result);
    ...
    void testUpdateSharedSpeedMethod() throws Exception {
        ...
        java.lang.reflect.Method method =
                VersusGameController.class.getDeclaredMethod("updateSharedSpeed", int.class);
        method.setAccessible(true);
    ...
    void testProcessInputsMethod() throws Exception {
        ...
        java.lang.reflect.Method method =
                VersusGameController.class.getDeclaredMethod("processInputs");
        method.setAccessible(true);
