...
public class AppTest {
    ...
    void testGetCurrentWindowSizeMethod() throws Exception {
        ...
        java.lang.reflect.Method method = App.class.getDeclaredMethod("getCurrentWindowSize", 
            Stage.class, SceneManager.class);
    ...
    void testVariousWindowSizes() throws Exception {
        ...
        String[] expectedSizes = {"SMALL", "SMALL", "SMALL", "SMALL", "MEDIUM", 
        ...
        for (int i = 0; i < testWidths.length; i++) {
            ...
            assertEquals(expectedSizes[i], result, 
    ...
    void testAppMethodExistence() {
        ...
        assertDoesNotThrow(() -> {
            ...
            java.lang.reflect.Method getCurrentWindowSizeMethod = 
                appClass.getDeclaredMethod("getCurrentWindowSize", Stage.class, SceneManager.class);
